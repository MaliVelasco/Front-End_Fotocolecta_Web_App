...
export class PerfilAdminPage implements OnInit {
  ...
  constructor() { 
    ...
    this.admin = {
      name: 'Dr. José Antonio Santos Moreno',
      email: 'admin.ejempll@gmail.com',
      ...
      address: 'Hornos 1003, colonia noche buena, sta. Cruz Xoxo',
      phone: '5774878',
      institution: 'CIIDIR',
      publications: 'AQUI ENCUENTRA SUS PUBLICACIONES'
    };
  }
